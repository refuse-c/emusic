 ...
 * @LastEditTime: 2021-08-03 20:23:33
 * @Description:
 */
 ...
 * @param {area} : ALL:全部,ZH:华语,EA:欧美,KR:韩国,JP:日本
 */
export const albumNew = (params: { limit: number; offset: number; area: string }) => get('/album/new', params);
