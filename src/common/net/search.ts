 ...
 * @LastEditTime: 2021-07-29 11:06:16
 * @Description: 搜索接口
 */
 ...
 */
export const search = (params: { keywords: string; limit?: number; type: number | string }) => get('/search', params);
 ...
 * @Description:
 */
export const searchHotSuggest = (params: { keywords: string; type?: string }) => get('/search/suggest', params);
 ...
 * @Description:
 */
export const searchHotMultimatch = (params: { keywords: string }) => get('/search/multimatch', params);
